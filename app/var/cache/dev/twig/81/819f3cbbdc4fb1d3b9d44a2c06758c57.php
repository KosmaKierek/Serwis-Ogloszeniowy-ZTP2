...
/* tag/edit.html.twig */
class __TwigTemplate_057c12c7d4b6c563786b0604cb21d99d extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        // line 1
        yield from $this->load("default/_form.html.twig", 1)->unwrap()->yield(CoreExtension::merge($context, ["page_title" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("title.tag_edit", ["%id%" => ((CoreExtension::getAttribute($this->env, $this->source,         // line 2
...
(isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 3, $this->source); })()), "submit_label" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("action.edit"), "back_to_list_path" => "tag_index"]));
    ...
    page_title: 'title.tag_edit'|trans({'%id%': tag.id|default('')}),
    form: form,
    submit_label: 'action.edit'|trans,
    back_to_list_path: 'tag_index',
} %}", "tag/edit.html.twig", "/home/wwwroot/app/templates/tag/edit.html.twig");
    }
}
