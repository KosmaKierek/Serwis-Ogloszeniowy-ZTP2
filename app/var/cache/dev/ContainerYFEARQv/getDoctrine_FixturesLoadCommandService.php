...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([['fixture' => new \App\DataFixtures\AdvertFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\CategoryFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\TagFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\UserFixtures(($container->privates['security.user_password_hasher'] ?? $container->load('getSecurity_UserPasswordHasherService'))), 'groups' => []]]);
