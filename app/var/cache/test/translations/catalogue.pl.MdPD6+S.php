...
$catalogue = new MessageCatalogue('pl', array (
  ...
  'messages' => 
  array (
    'label.actions' => 'Operacje',
    'label.id' => 'Id',
    'label.title' => 'Tytuł',
    'label.content' => 'Zawartość',
    'label.tags' => 'Tagi',
    'action.advert_index' => 'Strona główna',
    'message.empty_list' => 'Lista jest pusta',
    'message.record_not_found' => 'Nie znaleziono rekordu',
    'title.record_list' => 'Lista rekordów',
    'title.record_view' => 'Podgląd rekordu #%id%',
    'label.created_at' => 'Data utworzenia',
    'label.updated_at' => 'Data aktualizacji',
    'label.category' => 'Kategoria',
    'action.show' => 'Pokaż',
    'action.back_to_list' => 'Powrót do listy',
    'title.category_list' => 'Lista kategorii',
    'title.category_details' => 'Szczegóły kategorii',
    'action.edit' => 'Edytuj',
    'action.delete' => 'Usuń',
    'action.save' => 'Zapisz',
    'title.category_edit' => 'Edytuj kategorię',
    'message.category_contains_adverts' => 'Kategoria zawiera ogłoszenia',
    'message.created_successfully' => 'Utworzono pomyślnie',
    'message.deleted_successfully' => 'Usunięto pomyślnie',
    'title.category_delete' => 'Usuwanie kategorii',
    'title.category_create' => 'Tworzenie kategorii',
    'message.form_error' => 'Błąd formularza',
    'action.create' => 'Stwórz',
    'title.tag_list' => 'Lista tagów',
    'title.tag_edit' => 'Edytuj tag',
    'title.tag_delete' => 'Usuwanie tagu',
    'title.tag_details' => 'Szczegóły tagu',
    'title.tag_create' => 'Tworzenie tagu',
    'message.not_allowed' => 'Błąd',
    'message.changed_successfully' => 'Zmiany wprowadzone pomyślnie',
    'message.edited_successfully' => 'Zmiany wprowadzone pomyślnie',
    'message.wrong_current_password' => 'Hasła się nie zgadzają',
    'message.invalid_repeated_password' => 'Hasła się nie zgadzają',
    'label.author' => 'Twórca ogłoszenia',
    'title.change_email' => 'Zmień email',
    'title.change_password' => 'Zmień hasło',
    'title.advert_edit' => 'Edytuj ogłoszenie',
    'title.advert_delete' => 'Usuń ogłoszenie',
    'title.advert_details' => 'Szczegóły ogłoszenia',
    'title.advert_create' => 'Stwórz ogłoszenie',
    'title.advert_list' => 'Lista ogłoszeń',
    'title.user_list' => 'Lista użytkowników',
    'action_logout' => 'Wyloguj się',
    'action.register' => 'Zarejestruj się',
    'title.user_edit' => 'Edytuj dane użytkownika',
    'title.user_delete' => 'Usuń użytkownika',
    'label.email' => 'Email',
    'label.repeat_password' => 'Powtórz hasło',
    'label.remember_me' => 'Zapamiętaj mnie',
    'action.sign_in' => 'Zaloguj się',
    'label.current_password' => 'Aktualne hasło',
    'label.new_password' => 'Nowe hasło',
    'label.repeat_new_password' => 'Powtórz nowe hasło',
    'label.password' => 'Hasło',
    'action_login' => 'Zaloguj się',
    'action.user_list' => 'Lista użytkowników',
    'action.tag_list' => 'Lista tagów',
    'action.category_list' => 'Lista kategorii',
    'title.registration' => 'Proszę się zarejestrować',
    'label.invalid_tags' => 'Błąd tagów',
    'message.adverts_contain_tag' => 'Tag jest używany',
  ),
));
...
$catalogueEn = new MessageCatalogue('en', array (
  ...
  array (
    ...
    'label.tags' => 'tags',
    'action.advert_index' => 'advert index',
    'message.empty_list' => 'empty list',
    'message.record_not_found' => 'record not found',
    'title.record_list' => 'record list',
    'title.record_view' => 'view record #%id%',
    'label.created_at' => 'created at',
    'label.updated_at' => 'updated at',
    'label.category' => 'category',
    'action.show' => 'show',
    'action.back_to_list' => 'back to list',
    'title.category_list' => 'category list',
    'title.category_details' => 'category details',
    'action.edit' => 'edit',
    'action.delete' => 'delete',
    'action.save' => 'save',
    'title.category_edit' => 'edit category',
    'message.category_contains_adverts' => 'category contains adverts',
    'message.created_successfully' => 'created successfully',
    'message.deleted_successfully' => 'deleted successfully',
    'title.category_delete' => 'delete category',
    'title.category_create' => 'create category',
    'message.form_error' => 'form error',
    'action.create' => 'create',
    'title.tag_list' => 'tag list',
    'title.tag_edit' => 'edit tag',
    'title.tag_delete' => 'delete tag',
    'title.tag_details' => 'tag details',
    'title.tag_create' => 'create tag',
    'message.not_allowed' => 'error',
    'message.changed_successfully' => 'changed successfully',
    'message.edited_successfully' => 'edited successfully',
    'message.wrong_current_password' => 'invalid current password',
    'message.invalid_repeated_password' => 'invalid repeated password',
    'label.author' => 'author',
    'title.change_email' => 'change email',
    'title.change_password' => 'change password',
    'title.advert_edit' => 'edit advert',
    'title.advert_delete' => 'delete advert',
    'title.advert_details' => 'advert details',
    'title.advert_create' => 'create advert',
    'title.advert_list' => 'advert list',
    'title.user_list' => 'user list',
    'action_logout' => 'log out',
    'action.register' => 'register',
    'title.user_edit' => 'edit user',
    'title.user_delete' => 'delete user',
    'label.email' => 'email',
    ...
    'action_login' => 'log in',
    'action.user_list' => 'user list',
    'action.tag_list' => 'tag list',
    'action.category_list' => 'category list',
    'title.registration' => 'register',
    'label.invalid_tags' => 'invalid tags',
    'message.adverts_contain_tag' => 'adverts contain tag',
  ),
));
