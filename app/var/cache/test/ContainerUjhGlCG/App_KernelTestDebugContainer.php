...
class App_KernelTestDebugContainer extends Container
{
    ...
    {
        $container->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('8EQAAY6voC', 0, (\dirname(__DIR__, 3).'/share/test/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->privates['cache.asset_mapper.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0LC9l8rwut', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        $container->privates['cache.http_client.pool.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('0P6-1WUK-V', 0, (\dirname(__DIR__, 3).'/share/test/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        $container->privates['cache.messenger.restart_workers_signal.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('l5lpi3+2D+', 0, (\dirname(__DIR__, 3).'/share/test/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('arcmBnURCu', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('59TAz56D6l', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_is_csrf_token_valid_attribute_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ruN2hy37zJ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_is_granted_attribute_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('87GHBFCUYx', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sQEQ1YVT3I', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fR0C25VDpc', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MpNdgv9YfT', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getDebug_ArgumentResolver_InnerService($container)
    {
        $instance = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver(($container->privates['argument_metadata_factory'] ??= new \Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadataFactory()), new RewindableGenerator(function () use ($container) {
            ...
            yield 8 => ($container->privates['.debug.value_resolver.App\\Resolver\\AdvertListInputFiltersDtoResolver'] ?? $container->load('getAdvertListInputFiltersDtoResolverService'));
            ...
            'App\\Resolver\\AdvertListInputFiltersDtoResolver' => ['privates', '.debug.value_resolver.App\\Resolver\\AdvertListInputFiltersDtoResolver', 'getAdvertListInputFiltersDtoResolverService', true],
            ...
            'App\\Resolver\\AdvertListInputFiltersDtoResolver' => '?',
    ...
    protected static function getDebug_ControllerResolver_InnerService($container)
    {
        ...
        $instance->allowControllers(['App\\Kernel', 'App\\Controller\\AdvertController', 'App\\Controller\\CategoryController', 'App\\Controller\\HelloController', 'App\\Controller\\SecurityController', 'App\\Controller\\TagController', 'App\\Controller\\UserController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getDebug_Security_Access_DecisionManager_InnerService($container)
    {
        $instance = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () use ($container) {
            ...
            yield 4 => ($container->privates['.debug.security.voter.App\\Security\\Voter\\AdvertVoter'] ?? $container->load('getAdvertVoterService'));
            yield 5 => ($container->privates['.debug.security.voter.App\\Security\\Voter\\UserVoter'] ?? $container->load('getUserVoterService'));
    ...
    protected static function getDebug_Serializer_InnerService($container)
    {
        ...
        $instance = new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.denormalizer.unwrapping'] ?? self::getSerializer_Denormalizer_UnwrappingService($container)), $c, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.flatten_exception'] ??= new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer()), $c, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.problem'] ?? self::getSerializer_Normalizer_ProblemService($container)), $c, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.uid'] ??= new \Symfony\Component\Serializer\Normalizer\UidNormalizer([])), $c, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.datetime'] ??= new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer([])), $c, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.constraint_violation_list'] ?? self::getSerializer_Normalizer_ConstraintViolationListService($container)), $c, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($a, $c, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.datetimezone'] ??= new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer()), $c, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.dateinterval'] ??= new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer([])), $c, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.form_error'] ??= new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer()), $c, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.backed_enum'] ??= new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer()), $c, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.number'] ??= new \Symfony\Component\Serializer\Normalizer\NumberNormalizer()), $c, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.data_uri'] ?? self::getSerializer_Normalizer_DataUriService($container)), $c, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.translatable'] ?? self::getSerializer_Normalizer_TranslatableService($container)), $c, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.json_serializable'] ??= new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, [])), $c, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.denormalizer.array'] ??= new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer()), $c, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($b, $c, 'default')], [new \Symfony\Component\Serializer\Debug\TraceableEncoder(($container->privates['serializer.encoder.xml'] ??= new \Symfony\Component\Serializer\Encoder\XmlEncoder([])), $c, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(($container->privates['serializer.encoder.json'] ??= new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL, [])), $c, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(($container->privates['serializer.encoder.yaml'] ??= new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL, [])), $c, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(($container->privates['serializer.encoder.csv'] ??= new \Symfony\Component\Serializer\Encoder\CsvEncoder([])), $c, 'default')], []);
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_EventManagerService($container)
    {
        ...
        ]), [[['postGenerateSchema'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['onSchemaCreateTable'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_token_provider_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.pdo_session_handler_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.lock_store_schema_listener'], [['loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners'], [['onFlush'], 'turbo.doctrine.event_listener'], [['postFlush'], 'turbo.doctrine.event_listener'], [['prePersist'], 'stof_doctrine_extensions.listener.timestampable'], [['onFlush'], 'stof_doctrine_extensions.listener.timestampable'], [['loadClassMetadata'], 'stof_doctrine_extensions.listener.timestampable'], [['prePersist'], 'stof_doctrine_extensions.listener.sluggable'], [['onFlush'], 'stof_doctrine_extensions.listener.sluggable'], [['loadClassMetadata'], 'stof_doctrine_extensions.listener.sluggable']]);
    ...
    protected static function getDoctrine_Orm_ContainerRepositoryFactoryService($container)
    {
        return $container->privates['doctrine.orm.container_repository_factory'] = new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\AdvertRepository' => ['privates', 'App\\Repository\\AdvertRepository', 'getAdvertRepositoryService', true],
    ...
    protected static function getLocaleAwareListenerService($container)
    {
        return $container->privates['locale_aware_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleAwareListener(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['slugger'] ??= new \Symfony\Component\String\Slugger\AsciiSlugger('pl'));
    ...
    {
        return $container->privates['locale_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleListener(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'pl', ($container->services['router'] ?? self::getRouterService($container)), false, []);
    }
    ...
    protected static function getRouter_RequestContextService($container)
    {
        ...
        $instance->setParameters(['_functions' => ($container->privates['router.expression_language_provider'] ?? self::getRouter_ExpressionLanguageProviderService($container)), '_locale' => 'pl']);
    ...
    {
        return $container->privates['translation.locale_switcher'] = new \Symfony\Component\Translation\LocaleSwitcher('pl', new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['slugger'] ??= new \Symfony\Component\String\Slugger\AsciiSlugger('pl'));
            yield 1 => ($container->privates['translator.default'] ?? self::getTranslator_DefaultService($container));
    ...
    protected static function getTwigService($container)
    {
        ...
        $instance->addExtension(($container->privates['twig.extension.markdown'] ??= new \Twig\Extra\Markdown\MarkdownExtension()));
        $instance->addExtension(($container->privates['twig.extension.intl'] ??= new \Twig\Extra\Intl\IntlExtension()));
     ...
     */
    protected static function getTwig_Extension_IntlService($container)
    {
        return $container->privates['twig.extension.intl'] = new \Twig\Extra\Intl\IntlExtension();
    }
     ...
     */
    protected static function getTwig_Extension_MarkdownService($container)
    {
