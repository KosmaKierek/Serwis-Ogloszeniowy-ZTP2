...
class __TwigTemplate_1085d9ffd71734c234ed3c1911b38a41 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 9, $this->source); })()), "session", [], "any", false, false, false, 9), "flashBag", [], "any", false, false, false, 9), "all", [], "any", false, false, false, 9));
        $context['loop'] = [
        ...
        foreach ($context['_seq'] as $context["type"] => $context["messages"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
                // line 11
                yield "        ";
                yield from $this->load("default/_single_alert_message.html.twig", 11)->unwrap()->yield($context);
                // line 12
                yield "    ";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
    ...
    {
        return array (  86 => 12,  83 => 11,  65 => 10,  48 => 9,);
    }
...
{% for type, messages in app.session.flashBag.all %}
    ...
    {% endfor %}
{% endfor %}", "default/_flash_messages.html.twig", "/home/wwwroot/app/templates/default/_flash_messages.html.twig");
    }
}
